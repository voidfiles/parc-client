...
(function () {
    ...
    var Range = window.xrange_path.Range;
    ...
    //
    var Highlighter = window.Highlighter = function Highlighter(element, options) {
    ...
    //
    // Returns nothing.
    Highlighter.prototype.drawAll = function (annotations, cb) {
        var self = this;
    ...
    window.HighlighterStandalone = function standalone(element, options) {
        var widget = new window.Highlighter(element, options);

        return {
            destroy: function () { widget.destroy(); },
            annotationsLoaded: function (anns, cb) { widget.drawAll(anns, cb); },
